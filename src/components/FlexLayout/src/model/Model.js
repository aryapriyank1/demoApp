...
export class Model {
  ...
  static toTypescriptInterfaces() {
    ...
    console.log(
      RowNode.getAttributeDefinitions().toTypescriptInterface('Row', Model._attributeDefinitions)
    );
    console.log(
    ...
    console.log(
      TabNode.getAttributeDefinitions().toTypescriptInterface('Tab', Model._attributeDefinitions)
    );
    console.log(
